(function () {
  ...
  assistant.addEventListener('close', () => { ai.controller?.abort(); void window.MoonChat.stop(); });
  ...
  document.addEventListener('click', event => {
    ...
    if (action === 'open') openAssistant('chat');
    if (action === 'review') openAssistant('review');
    if (action === 'settings') openSettings();
    if (action === 'smart') openSmart();
    if (['tab-review', 'tab-question', 'tab-chat'].includes(action)) {
      void window.MoonChat.stop();
